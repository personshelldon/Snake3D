...
/*SF_DATA;ver:1.03;sub:START;pass:START;ps:flbk:Mobile/Diffuse,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:True,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:2,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0,fgcg:0,fgcb:0,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:True;n:type:ShaderForge.SFN_Final,id:3948,x:32766,y:32710,varname:node_3948,prsc:2|diff-6508-RGB,spec-916-OUT;n:type:ShaderForge.SFN_Color,id:6508,x:32269,y:32657,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_6508,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Slider,id:916,x:32246,y:32878,ptovrint:False,ptlb:Specular,ptin:_Specular,varname:node_916,prsc:2,min:0,cur:0.5636281,max:2;proporder:6508-916;pass:END;sub:END;*/

Shader "Shader Forge/OnlyColor" {
    Properties {
        _Color ("Color", Color) = (0.5,0.5,0.5,1)
        _Specular ("Specular", Range(0, 2)) = 0.5636281
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
